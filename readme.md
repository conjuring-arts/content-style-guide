# Welcome to the Headmaster Content Style Guide

This style guide is primarily for Headmaster employees, but we hope it’s helpful to other organizations as well.

If you're looking for the Headmaster Content Style Guide website, visit [styleguide.headmaster.com](http://styleguide.headmaster.com).

Whether or not you work at Headmaster, we welcome your thoughts and suggestions. To learn more about sending us feedback or adapting this guide to create your own, see the Contributing file.

## Using the Guide

MailChimp wrote a [blog post](http://devs.mailchimp.com/blog/how-we-built-the-mailchimp-content-style-guide/) and set up an [example Middleman project](https://github.com/mailchimp/middleman-with-md-submodule-example).
