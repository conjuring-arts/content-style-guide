...
Our email newsletters help empower and inform our recipients. Here are the most common types of content we send by email:

- Product and feature announcements
- Tips for getting the most out of techonology
- Regular monthly newsletters
- Automated series (Getting Started with GitHub)
...
When sending an email newsletter from Headmaster, use the 3rd person “we.” When sending a newsletter as an individual, use the 1st person.
...
Use the preview mode to begin, and run an Inbox Inspection to see your newsletter in different email clients. Read your campaign out loud to yourself, then send a test to a colleauge for a second look.
